...
class HomeAdapter (val context : Context, private val onClick: onClickListener): RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        if(listData[position].reference_id == 0 || listData[position].reference_id == listData[position].id) {
            holder?.itemView.textView6.visibility = View.VISIBLE
        }
